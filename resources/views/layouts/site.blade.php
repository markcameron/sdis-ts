                    ...
                    <nav class="hidden space-x-10 lg:flex">
                        <div class="relative">
                            <button type="button" @click="dropdownIsOpen = !dropdownIsOpen"
                                class="group inline-flex items-center font-bold hover:text-gray-300"
                                aria-expanded="false">
                                <span>Le SDIS</span>
                            ...
                            <div x-show="dropdownIsOpen" x-transition:enter="transition ease-out duration-100"
                                ...
                                <div class="py-1" role="none">
                                    <a href="#" class="block px-4 py-2 font-bold hover:bg-gray-500"
                                        role="menuitem" tabindex="-1" id="menu-item-0">Link</a>
                                    <a href="#" class="block px-4 py-2 font-bold hover:bg-gray-500"
                                        role="menuitem" tabindex="-1" id="menu-item-1">Link</a>
                                    <a href="#" class="block px-4 py-2 font-bold hover:bg-gray-500"
                                        role="menuitem" tabindex="-1" id="menu-item-2">Link</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="px-5 pt-5 pb-6">
                        ...
                        <div class="mt-6">
                            <nav class="flex flex-col">
                                <div class="relative">
                                    <button type="button" @click="dropdownIsOpen = !dropdownIsOpen"
                                        class="group inline-flex items-center p-3 font-bold hover:text-gray-300"
                                        aria-expanded="false">
                                        <span>Le SDIS</span>
                                        <svg class="ml-2 h-5 w-5 group-hover:text-gray-300"
                                    ...
                                    <div x-show="dropdownIsOpen" x-transition:enter="transition ease-out duration-100"
                                        ...
                                        x-transition:leave-start="transform opacity-100 scale-100"
                                        x-transition:leave-end="transform opacity-0 scale-95"
                                        class="absolute left-0 z-10 mt-2 w-56 origin-top-right rounded-md border-2 border-gray-600 bg-gray-700"
                                ...
                                <a href="#" class="p-3 font-bold hover:bg-gray-800">Prestations</a>
                                <a href="#" class="p-3 font-bold hover:bg-gray-800">Documents</a>
                                <a href="#" class="p-3 font-bold hover:bg-gray-800">Devenir Sapeur Pompier</a>
                                <a href="#" class="p-3 font-bold hover:bg-gray-800">Contact</a>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <div class="mt-10 xl:mt-0">
                ...
                <address class="my-8 grid items-start gap-6 text-lg not-italic sm:grid-cols-2 lg:grid-cols-1">
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <a href="tel:+41229609620" class="text-gray-50 hover:text-gray-50">022 960 96 20</a>
                    </div>
                    <div class="flex items-center gap-6">
                        ...
                        <a href="mailto:info@sdis-ts.ch"
                            class="text-gray-50 hover:text-gray-50">info@sdis-ts.ch</a>
                    </div>
                </address>
            </div>
            ...
            <div
                ...
                <div class="flex space-x-6 md:order-2">
                    <a href="https://www.facebook.com/sdists665/" class="text-gray-400 hover:text-gray-500"
                        target="_blank">
                    ...
                    <a href="https://github.com/markcameron/sdis-ts" class="text-gray-400 hover:text-gray-500"
                        target="_blank">
